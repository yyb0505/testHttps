...
<!-- gallery -->
	<div class="gallery-w3layouts" id="imgList">
		<div class="container categoryDiv">
			...
			<div class="gallery-grids">
				...
				<div class="gallery-grid"  v-for="(img,index) in imgList">
					<a class="category book popup-with-zoom-anim  button-isi zoomIn animated" data-wow-delay=".5s" :href="'#small-dialog'+img.id">
						<img :src="img.picPath" alt=" " :id="'img'+img.id" class="img-responsive zoom-img" />
						<div class="info">
							<div class="up-cover"></div>
							<span class="image-title">{{img.picDescribe}}</span>
							<div class="image-ops">
								<span aria-label="查找相似图片" class="hint--top">查找</span>
	...
	<script>
		...
		let groupList = new Vue({
			...
			methods:{
				downloadImg: function(num){

					let image = new Image();
					image.src = "http://192.168.64.134/group1/M00/00/00/wKhAhV7LyoWAVe9bADXbCaZpheQ37..png";
					// 解决跨域 Canvas 污染问题
					...
					/*$.ajax({
						url: "insertImgDownLoadRec",
						type: "post",
						dataType:"json",
						data:{userId:2,picId:num},
