var app = new Vue({
        ...
        data() {
            return {
                list: [
                    { imgUrl: '../images/views/img105.png' },
                    { imgUrl: '../images/views/img106.png' },
                    { imgUrl: '../images/views/img107.png' },
                    { imgUrl: '../images/views/img108.png' },
                    { imgUrl: '../images/views/img109.png' }
                ],
