			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="hover-effect active"><a href="about.jsp">About</a></li>
						<li class="hover-effect"><a href="imgList.jsp">Games</a></li>
						<li class="hover-effect"><a href="community.jsp">News</a></li>
						<li class="hover-effect"><a href="contact.jsp">Contact</a></li>
					</ul>
				</div>
		...
		<div class="container">
			...
			<div class="about-grids-w3-agileits">
				<div class="col-md-6 about-grid-left-agileits-w3layouts">
					<ul>
						<li><i>1.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Qui ratione voluptatem dolores eos qui">Qui ratione voluptatem dolores</span></a></li>
						<li><i>2.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Dolores eos qui ratione voluptatem sequi">Dolores eos qui ratione volu</span></a></li>
						<li><i>3.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Voluptatem quia voluptas sit asper">Voluptatem quia voluptas sit asper</span></a></li>
						<li><i>4.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Consectetur adipiscing elit, incid">Consectetur adipiscing elit, incid</span></a></li>
						<li><i>5.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Quia voluptas sit aspernatur aut odit">Quia voluptas sit aspernatur aut</span></a></li>
						<li><i>6.</i><a class="link link--kumya" href="releaseDetail.jsp"><span data-letters="Eos qui ratione voluptatem sequi">Eos qui ratione voluptatem sequi</span></a></li>
					</ul>
				</div>
	...
	<div class="container">
		...
		<div class="col-md-5 footer-middle-w3">
			...
			<div class="col-md-3 img-w3-agile">
				<a href="releaseDetail.jsp"><img src="images/ng1.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="releaseDetail.jsp"><img src="images/ng2.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="releaseDetail.jsp"><img src="images/ng3.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile">
				<a href="releaseDetail.jsp"><img src="images/ng4.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="releaseDetail.jsp"><img src="images/ng5.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="releaseDetail.jsp"><img src="images/ng6.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="releaseDetail.jsp"><img src="images/ng7.jpg" alt=" " /></a>
			</div>
			<div class="col-md-3 img-w3-agile footer-middle-wthree">
				<a href="releaseDetail.jsp"><img src="images/ng8.jpg" alt=" " /></a>
			</div>
			<div class="clearfix"></div>
		</div>
		...
		<div class="clearfix"></div>
		<div class="copyright">
			<p>Copyright &copy; fangjue123.com<a target="_blank" href="http://sc.chinaz.com/moban/"></a></p>
		</div>
	</div>
</div>
<!-- //footer -->
