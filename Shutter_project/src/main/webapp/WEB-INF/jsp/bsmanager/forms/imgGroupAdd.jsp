	...
	<form id="imgGroupBean" action="" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-md-10 col-sm-10">
				<input type="email" class="form-control" name="groName" >
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 col-sm-2 control-label">组描述：</label>
			<div class="col-md-10 col-sm-10">
				<input type="email" class="form-control" name="groDescribe">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 col-sm-2 control-label">类别id</label>
			<div class="col-md-10 col-sm-10">
				<input type="email" class="form-control" name="catId">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-6 col-sm-6">
				<button class="btn btn-success center-block" type="button" onclick="addImgGroup()">添加</button>
			</div>
			<div class="col-md-6 col-sm-6">
...
<script>
	...
	function addImgGroup(){
		let issb = $("#imgGroupBean").serialize();
		$.ajax({
			url: "addImgGroup",
			type: "post",
			dataType:"json",
